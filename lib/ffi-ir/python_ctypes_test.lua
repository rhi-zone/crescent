-- lib/ffi-ir/python_ctypes_test.lua
-- Tests for lib/ffi-ir/python_ctypes.lua (the Python `ctypes` projector),
...
local ctypes   = require("lib.ffi-ir.python_ctypes")
...
T.describe("lib.ffi-ir.python_ctypes", function()
