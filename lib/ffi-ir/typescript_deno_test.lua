-- lib/ffi-ir/typescript_deno_test.lua
-- Tests for lib/ffi-ir/typescript_deno.lua (the Deno FFI consumer projector),
...
local deno     = require("lib.ffi-ir.typescript_deno")
...
T.describe("lib.ffi-ir.typescript_deno", function()
