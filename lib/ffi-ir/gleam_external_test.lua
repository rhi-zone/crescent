-- lib/ffi-ir/gleam_external_test.lua
-- Tests for lib/ffi-ir/gleam_external.lua (the Gleam `@external`
...
local gleam    = require("lib.ffi-ir.gleam_external")
...
T.describe("lib.ffi-ir.gleam_external", function()
