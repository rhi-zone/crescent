-- lib/ffi-ir/ruby_ffi_test.lua
-- Tests for lib/ffi-ir/ruby_ffi.lua (the Ruby `ffi` gem projector),
...
local ruby     = require("lib.ffi-ir.ruby_ffi")
...
T.describe("lib.ffi-ir.ruby_ffi", function()
