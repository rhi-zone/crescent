-- lib/ffi-ir/java_jni_test.lua
-- Tests for lib/ffi-ir/java_jni.lua (the JNI projector), ported from
...
local jni      = require("lib.ffi-ir.java_jni")
...
T.describe("lib.ffi-ir.java_jni", function()
