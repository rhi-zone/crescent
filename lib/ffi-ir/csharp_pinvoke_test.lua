-- lib/ffi-ir/csharp_pinvoke_test.lua
-- Tests for lib/ffi-ir/csharp_pinvoke.lua (the .NET/P-Invoke backend), ported
...
local dotnet   = require("lib.ffi-ir.csharp_pinvoke")
...
-- TYPECHECKER WORKAROUND: verbatim copies of lib/type-ir/init.lua's declarations,
-- required in every consumer of the type-ir/ffi-ir modules. See the same
-- three lines (and the full explanation) in lib/ffi-ir/init.lua and
-- lib/ffi-ir/csharp_pinvoke.lua, and the TODO.md entry they point at.
--:: Meta = { [string]: unknown }
...
T.describe("lib.ffi-ir.csharp_pinvoke", function()
