-- lib/ffi-ir/ocaml_melange_test.lua
-- Tests for lib/ffi-ir/ocaml_melange.lua (the Melange `external`-declaration
...
local melange  = require("lib.ffi-ir.ocaml_melange")
...
T.describe("lib.ffi-ir.ocaml_melange", function()
