-- lib/ffi-ir/rust_c_abi_test.lua
-- Tests for lib/ffi-ir/rust_c_abi.lua (the Rust-implementing-a-C-ABI
...
local rust     = require("lib.ffi-ir.rust_c_abi")
...
T.describe("lib.ffi-ir.rust_c_abi", function()
