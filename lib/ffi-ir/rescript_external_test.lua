-- lib/ffi-ir/rescript_external_test.lua
-- Tests for lib/ffi-ir/rescript_external.lua (the ReScript
...
local rescript = require("lib.ffi-ir.rescript_external")
...
T.describe("lib.ffi-ir.rescript_external", function()
	...
	T.describe("rescript_type_from_type_ref re-export", function()
		...
		T.it("is the same function type_ref_rescript_native exports", function()
			local native = require("lib.type-ir.rescript_native")
