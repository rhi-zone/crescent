-- lib/ffi-ir/typescript_bun_test.lua
-- Tests for lib/ffi-ir/typescript_bun.lua (the Bun `bun:ffi` consumer
...
local bun      = require("lib.ffi-ir.typescript_bun")
...
T.describe("lib.ffi-ir.typescript_bun", function()
