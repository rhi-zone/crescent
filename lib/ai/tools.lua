...
--: ({ model: string, messages: ai_message[], tools: ai_tool[], handlers: { [string]: (args: { [string]: unknown }) -> string }, max_rounds?: integer, max_tokens?: integer, temperature?: number, provider?: ai_provider }) -> ai_response | nil, string | nil
