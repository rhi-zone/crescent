...
--:: PosMap = { [unknown]: Pos2D }
--:: DispMap = { [unknown]: Pos2D }
--:: AdjSet = { [unknown]: boolean }
--:: AdjMap = { [unknown]: AdjSet }
--:: OutAdjList = { [unknown]: { [integer]: GNode } }
--:: InDegMap = { [unknown]: integer }
--:: LayerMap = { [unknown]: integer }
