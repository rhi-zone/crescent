	...
	aliases = {
...

		{
			...
			actions     = {
				...
				{ label = "Edit .zshrc",  type = "shell", command = "${EDITOR:-nano} ~/.zshrc" },
			},
		},
...

		{
			...
			platform    = { "windows" },
			actions     = {
				{ label = "Open Task Manager (Startup tab)", type = "shell", command = "taskmgr" },
...

		{
			...
			platform    = { "windows" },
			actions     = {
				{ label = "Open Windows Features",   type = "shell", command = "optionalfeatures" },
