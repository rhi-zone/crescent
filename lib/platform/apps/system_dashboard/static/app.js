(function () {
  ...
  function renderPrimitive(p) {
    ...
    switch (p.type) {
      ...
      case "live_table":
      case "event_stream": {
        // TODO: streaming transport (SSE/websocket) is not wired up yet. Show
        // a placeholder so packs that emit these don't fall through to the
        // unknown-type fallback.
        var sEl = document.createElement("div");
        sEl.className = "prim-stream-placeholder";
        sEl.textContent = "Streaming: " + String(p.type) + " (transport TBD)";
        return sEl;
      }
      default: {
