...
messageList.addEventListener("mouseover", function (e) {
  const msgEl = /** @type {HTMLElement | null} */ (/** @type {HTMLElement} */ (e.target).closest(".message"));
  if (!msgEl) return;
  const actions = /** @type {HTMLElement | null} */ (msgEl.querySelector(".message__actions"));
...
messageList.addEventListener("mouseout", function (e) {
  const msgEl = /** @type {HTMLElement | null} */ (/** @type {HTMLElement} */ (e.target).closest(".message"));
  if (!msgEl) return;
  if (msgEl.contains(/** @type {Node} */ (e.relatedTarget))) return;
  const actions = /** @type {HTMLElement | null} */ (msgEl.querySelector(".message__actions"));
...
messageList.addEventListener("click", async function (e) {
  ...
  if (action === "delete") {
    ...
    const actionsEl = /** @type {HTMLElement} */ (msgEl.querySelector(".message__actions"));
...
(async function () {
  ...
  if (card) {
    ...
    addMessage({ id: "", role: "system", content: "No card loaded. Use the card editor to import a character card." });
  }
...
/** @type {HTMLButtonElement} */
const btnLorebook = /** @type {HTMLButtonElement} */ (document.getElementById("btn-lorebook"));
/** @type {HTMLElement} */
const lorebookOverlay = /** @type {HTMLElement} */ (document.getElementById("lorebook-overlay"));
/** @type {HTMLButtonElement} */
const lorebookClose = /** @type {HTMLButtonElement} */ (document.getElementById("lorebook-close"));
/** @type {HTMLButtonElement} */
...
/** @type {HTMLButtonElement} */
const btnWorldInfo = /** @type {HTMLButtonElement} */ (document.getElementById("btn-world-info"));
/** @type {HTMLElement} */
const worldInfoOverlay = /** @type {HTMLElement} */ (document.getElementById("world-info-overlay"));
/** @type {HTMLButtonElement} */
const worldInfoClose = /** @type {HTMLButtonElement} */ (document.getElementById("world-info-close"));
/** @type {HTMLButtonElement} */
const worldInfoAdd = /** @type {HTMLButtonElement} */ (document.getElementById("world-info-add"));
/** @type {HTMLButtonElement} */
const worldInfoImport = /** @type {HTMLButtonElement} */ (document.getElementById("world-info-import"));
/** @type {HTMLButtonElement} */
const worldInfoExport = /** @type {HTMLButtonElement} */ (document.getElementById("world-info-export"));
/** @type {HTMLInputElement} */
const worldInfoFile = /** @type {HTMLInputElement} */ (document.getElementById("world-info-file"));
/** @type {HTMLElement} */
const worldInfoList = /** @type {HTMLElement} */ (document.getElementById("world-info-list"));
...
/** @type {HTMLButtonElement} */
const btnCardEdit = /** @type {HTMLButtonElement} */ (document.getElementById("btn-card-edit"));
/** @type {HTMLElement} */
...
/** @type {HTMLElement} */
const regexOverlay = /** @type {HTMLElement} */ (document.getElementById("regex-overlay"));
/** @type {HTMLButtonElement} */
const regexClose = /** @type {HTMLButtonElement} */ (document.getElementById("regex-close"));
/** @type {HTMLButtonElement} */
...
/** @type {HTMLButtonElement} */
const anToggle = /** @type {HTMLButtonElement} */ (document.getElementById("an-toggle"));
/** @type {HTMLElement} */
const anPanel = /** @type {HTMLElement} */ (document.getElementById("an-panel"));
/** @type {HTMLTextAreaElement} */
