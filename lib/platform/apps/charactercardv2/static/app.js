...
btnLorebook.addEventListener("click", function () { openCardEditor("lorebook"); });
...
btnCardEdit.addEventListener("click", function () { openCardEditor("identity"); });
...
btnRegex.addEventListener("click", function () { openCardEditor("regex"); });
