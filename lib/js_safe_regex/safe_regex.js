...
// AST nodes are created via Object.create(null) so they have no
// prototype — defense-in-depth that matches harden-mode bootstrap style.
...
function node(has_unbounded, is_anchor) {
  ...
  n.has_unbounded = has_unbounded;
  n.is_anchor = is_anchor;
  return n;
}
