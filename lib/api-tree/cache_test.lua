-- lib/api-tree/cache_test.lua
-- Tests for lib/api-tree/cache.lua (the IR fingerprinting primitives).
...
local cache = require("lib.api-tree.cache")

local ENTRY = "/repo/src/api.ts"

T.describe("lib.api-tree.cache", function()
