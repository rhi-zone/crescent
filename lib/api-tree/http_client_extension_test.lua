-- lib/api-tree/http_client_extension_test.lua
-- Tests for lib/api-tree/http_client_extension.lua (the client extension
-- protocol).
--
...
T.describe("lib.api-tree.http_client_extension", function()
