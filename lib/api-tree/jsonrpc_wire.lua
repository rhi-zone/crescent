-- lib/api-tree/jsonrpc_wire.lua — JSON-RPC 2.0 wire-format shapes, the standard
...
--
-- Re-exported from lib/type-ir/json_rpc.lua — the one place they are defined,
...
-- the whole batch.
--
-- The array test is `lib/api-tree`'s `is_array`, under which an empty table is
...
function M.is_request_shape(v)
	...
	if api_tree.is_array(t) then return false end
