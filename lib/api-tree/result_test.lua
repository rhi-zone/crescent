-- lib/api-tree/result_test.lua
-- Tests for lib/api-tree/result.lua (compose/pipe, Result, StreamEffect,
...
local R = require("lib.api-tree.result")
...
T.describe("lib.api-tree.result", function()
