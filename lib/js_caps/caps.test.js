...
test("dayZeroCaps: does not contain the deferred caps", () => {
  // kv_* and fetch_api are factory-shaped (config-bound per pack) so
  // they are intentionally absent from dayZeroCaps even though their
  // impls ship. navigate/dialog/toast are not yet implemented.
  const deferred = [
