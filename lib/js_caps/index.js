...
// module ships the 6 trivial ones (pure wraps with no design questions)
// plus set_timeout (cancellable via the cap-bridge AbortSignal
// extension; see docs/platform_isolation.md §4):
//
//   text_encode, text_decode, compress, decompress, console_log,
//   web_crypto_random, set_timeout.
//
// The remaining 10 (fetch_api, web_crypto_subtle, kv_*, navigate,
// dialog, toast, clipboard_write) involve design decisions and land in
// subsequent commits. Their names are NOT in dayZeroCaps yet -- callers
// wiring those caps must add them as additional Map entries alongside
// the ones this module exports.
//
