...
local function b64url_decode(s)
  local decoded, _ = base64.decode(s, { url = true })
  return decoded
end
...
if system_lib then
  ...
  local raw_fns = {
    ...
    d  = sl.argon2d_hash_raw,
  }
  local enc_fns = {
    id = sl.argon2id_hash_encoded,
    i  = sl.argon2i_hash_encoded,
    d  = sl.argon2d_hash_encoded,
  }
  local ver_fns = {
    id = sl.argon2id_verify,
    i  = sl.argon2i_verify,
    d  = sl.argon2d_verify,
  }
