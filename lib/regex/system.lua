...
function Regex:match(subject, init)
	...
	local ov = lib_a.pcre2_get_ovector_pointer_8(self_a._md) --[[: any]]
...
function M.compile(pattern, flags)
	...
	if code == nil then
		local errcode_a = errcode --[[: any]]
		local erroffset_a = erroffset --[[: any]]
