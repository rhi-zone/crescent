...
--:: TaskNode = { id: string, type: string, input: unknown, parent_id: string | nil, status: string, output: unknown, error: string | nil, spawned: { [integer]: string }, dependencies: { [integer]: string }, log: { [integer]: string } }
...
--:: ExecGraphNode = { id: string, type: string, input: unknown, output: unknown, status: string, error: string | nil, parent_id: string | nil, children: { [integer]: string }, dependencies: { [integer]: string } }
...
--:: RunOpts = { track: boolean | nil, scaffolds: { [integer]: Scaffold } | nil, on_task: ((TaskNode) -> ()) | nil }
...
--:: RunTaskFn = (g: Graph, executor: ExecutorFn, hooks: Hooks, task_id: string) -> ()
