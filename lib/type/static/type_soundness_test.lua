...
---------------------------------------------------------------------------
-- Primitive structural subtyping via prim_index
---------------------------------------------------------------------------

assert.describe("string <: structural table via prim_index", function()
    assert.it("string satisfies { sub: _ } (any field type)", function()
        no_errors([[
local s --: string
--: { sub: unknown }
local t = s
    ...
    assert.it("string satisfies { len: unknown }", function()
        no_errors([[
local s --: string
--: { len: unknown }
local t = s
    ...
    assert.it("function accepting { sub: unknown } can be called with string", function()
        no_errors([[
--: ({ sub: unknown }) -> boolean
local function has_sub(x)
    return true
end
local s --: string
local ok = has_sub(s)
    ...
    assert.it("string does NOT satisfy { nonexistent_xyz: unknown }", function()
        has_error([[
local s --: string
...
local t = s
    ...
    assert.it("string satisfies { gsub: unknown }", function()
        no_errors([[
local s --: string
--: { gsub: unknown }
local t = s
