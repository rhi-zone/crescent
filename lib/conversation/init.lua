...
--:: SqlConn = { execute: (self: unknown, string, ...unknown) -> (unknown | nil, string | nil), query: (self: unknown, string, ...unknown) -> ((() -> (unknown | nil)) | nil, string | nil), ... }
--:: Db = { _db: SqlConn, _time_fn: () -> integer, create_session: (Db, string, unknown) -> (unknown, string | nil), get_session: (Db, string) -> (unknown, string | nil), list_sessions: (Db, string) -> (unknown, string | nil), delete_session: (Db, string) -> (boolean | nil, string | nil), add_message: (Db, string, string | nil, string, string, unknown) -> (unknown, string | nil), get_message: (Db, string) -> (unknown, string | nil), get_children: (Db, string) -> (unknown, string | nil), get_canonical_path: (Db, string) -> (unknown, string | nil), swipe_to: (Db, string) -> (boolean | nil, string | nil), update_message: (Db, string, { [string]: unknown }) -> (unknown, string | nil), delete_subtree: (Db, string) -> (unknown, string | nil), get_roots: (Db, string) -> (unknown, string | nil), get_root_children: (Db, string) -> (unknown, string | nil) }
local db_mt = {}
db_mt.__index = db_mt
...
--: (Db, string, unknown) -> (unknown, string | nil)
...
--: (Db, string, string | nil, string, string, unknown) -> (unknown, string | nil)
...
--: (Db, string, { [string]: unknown }) -> (unknown, string | nil)
...
db_mt.delete_subtree = function(self, message_id)
	...
	if parent_id ~= nil then
		local children, cerr = self:get_children(tostring(parent_id))
...
db_mt.get_root_children = function(self, session_id)
	...
	return self:get_children(tostring(root_id))
end
