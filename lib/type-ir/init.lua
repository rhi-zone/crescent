-- lib/type-ir/init.lua — the TypeRef data model, ported from fractal's
...
-- `json_schema.lua` (draft 2020-12), `json_schema_07.lua`,
-- `json_schema_04.lua`, `openapi_30.lua` and
-- `openapi_20.lua`. Still unported: SQL DDL and the other ~20
...
-- and must not depend on the api-tree port (`lib/api-tree/init.lua`) — in
