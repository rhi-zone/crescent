-- lib/type-ir/json_rpc_test.lua
-- Tests for lib/type-ir/json_rpc.lua (JSON-RPC 2.0 codes + envelope).
...
local json_rpc = require("lib.type-ir.json_rpc")
...
T.describe("lib.type-ir.json_rpc", function()
