-- lib/type-ir/json_schema_07.lua — project a TypeRef to JSON Schema
-- draft-07. Ported from fractal's packages/type-ir/src/json-schema-07.ts.
--
-- Divergences from draft 2020-12 (json_schema.lua) handled here:
--
...
-- rather than assuming `string` — see json_schema.lua for the full
...
-- `type_ref_to_json_schema_04_document` in json_schema_04.lua for the
