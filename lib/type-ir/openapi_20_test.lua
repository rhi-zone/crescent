-- lib/type-ir/openapi_20_test.lua
-- Tests for lib/type-ir/openapi_20.lua: the TypeRef -> Swagger 2.0
...
local oas20    = require("lib.type-ir.openapi_20")
...
T.describe("lib.type-ir.openapi_20", function()
