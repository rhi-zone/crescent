-- lib/type-ir/kinds_common_test.lua
-- Tests for lib/type-ir/kinds_common.lua: the refined-kind
-- constructors and the lattice registrations they come with.
--
-- Unlike lib/type-ir/type_ir_test.lua, which prefixes every kind name to
...
T.describe("lib.type-ir.kinds_common", function()
  ...
  T.describe("lattice registration", function()
    ...
    T.it("every fixed-width integer refines `integer`", function()
      ...
      for i = 1, #widths do
        ...
        -- `integer -> number` is seeded by init.lua itself, so the full
