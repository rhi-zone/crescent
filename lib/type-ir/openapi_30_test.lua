-- lib/type-ir/openapi_30_test.lua
-- Tests for lib/type-ir/openapi_30.lua: the TypeRef -> OpenAPI 3.0
...
local oas30    = require("lib.type-ir.openapi_30")
...
T.describe("lib.type-ir.openapi_30", function()
