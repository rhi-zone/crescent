-- lib/type-ir/rust_wasm_bindgen_test.lua
-- Tests for lib/type-ir/rust_wasm_bindgen.lua, ported from fractal's
...
T.describe("lib.type-ir.rust_wasm_bindgen", function()
