-- lib/type-ir/gleam_native_test.lua
-- Tests for lib/type-ir/gleam_native.lua: the Gleam type-declaration
...
local gleam    = require("lib.type-ir.gleam_native")
...
T.describe("lib.type-ir.gleam_native", function()
