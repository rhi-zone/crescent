-- lib/type-ir/json_schema_07_test.lua
-- Tests for lib/type-ir/json_schema_07.lua: the TypeRef -> JSON
...
local js07        = require("lib.type-ir.json_schema_07")
...
T.describe("lib.type-ir.json_schema_07", function()
