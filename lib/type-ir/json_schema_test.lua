-- lib/type-ir/json_schema_test.lua
-- Tests for lib/type-ir/json_schema.lua: the TypeRef -> JSON Schema
...
local js       = require("lib.type-ir.json_schema")
...
T.describe("lib.type-ir.json_schema", function()
  ...
  T.describe("literal and enum", function()
    ...
    -- init.lua's `EnumShape` declares `members: string[]`, but a converter
