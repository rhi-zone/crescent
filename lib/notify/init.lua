...
--:: channel = { send: (self: any, msg: notify_msg) -> (boolean | nil, string | nil) }
--:: notify = { send: (self: any, msg: notify_msg) -> (boolean | nil, string | nil) }
--:: router = { send: (self: any, msg: notify_msg) -> { name: string, ok: boolean | nil, err: string | nil }[], add: (self: any, name: string, channel: channel, opts: ({ levels?: string[], topics?: string[], filter?: (msg: notify_msg) -> boolean } | nil)) -> nil }
--:: retry_channel = { send: (self: any, msg: notify_msg) -> (boolean | nil, string | nil) }
--:: rate_limited_channel = { send: (self: any, msg: notify_msg) -> (boolean | nil, string | nil) }
--:: batched_channel = { send: (self: any, msg: notify_msg) -> (boolean | nil, string | nil), flush: (self: any) -> (boolean | nil, string | nil) }
