-- lib/fractal/http_adapter_test.lua
-- Tests for lib/fractal/http_adapter.lua (the one materialization boundary).
--
...
local adapter = require("lib.fractal.http_adapter")
...
T.describe("lib.fractal.http_adapter", function()
