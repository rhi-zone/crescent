-- lib/fractal/type_ref_rust_serde_test.lua
-- Tests for lib/fractal/type_ref_rust_serde.lua: the Rust/serde projector.
--
...
T.describe("lib.fractal.type_ref_rust_serde", function()
