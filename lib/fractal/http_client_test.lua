-- lib/fractal/http_client_test.lua
-- Tests for lib/fractal/http_client.lua (the runtime HTTP client).
--
...
local client = require("lib.fractal.http_client")
...
T.describe("lib.fractal.http_client", function()
