-- lib/fractal/type_ref_json_schema_04_test.lua
-- Tests for lib/fractal/type_ref_json_schema_04.lua: the TypeRef -> JSON
...
local js04     = require("lib.fractal.type_ref_json_schema_04")
...
T.describe("lib.fractal.type_ref_json_schema_04", function()
