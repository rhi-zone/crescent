-- lib/fractal/ffi_ir_rust_wasm_bindgen_test.lua
-- Tests for lib/fractal/ffi_ir_rust_wasm_bindgen.lua (the ffi-ir wasm-bindgen
...
-- convention `type_ref_rust_wasm_bindgen_test.lua` follows for the data-shape
...
local wb       = require("lib.fractal.ffi_ir_rust_wasm_bindgen")
...
T.describe("lib.fractal.ffi_ir_rust_wasm_bindgen", function()
