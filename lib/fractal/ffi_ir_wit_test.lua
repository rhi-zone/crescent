-- lib/fractal/ffi_ir_wit_test.lua
-- Tests for lib/fractal/ffi_ir_wit.lua (the WIT projector), ported from
...
local wit      = require("lib.fractal.ffi_ir_wit")
...
T.describe("lib.fractal.ffi_ir_wit", function()
