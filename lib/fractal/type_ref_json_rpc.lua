-- lib/fractal/type_ref_json_rpc.lua — the JSON-RPC 2.0 standard error codes
...
-- type-ir sibling of `type_ref_json_schema.lua`'s projection and belongs with
...
-- Same open-bag reading of a JSON Schema `type_ref_json_schema.lua` uses.
...
-- `type_ref_json_schema.lua`'s module doc already documents for `unknown`.
