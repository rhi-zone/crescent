...
local function _json_span(s)
  local parts = {
    ...
    '"trace_id":'        .. _json_string(--[[:! string]] s.trace_id),
    '"span_id":'         .. _json_string(--[[:! string]] s.span_id),
    '"parent_span_id":'  .. (s.parent_span_id and _json_string(--[[:! string]] s.parent_span_id) or "null"),
