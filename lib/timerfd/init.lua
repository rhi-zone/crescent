...
if ffi.os == "Windows" then
	...
	--[[@class timerfd_c]]
	--[[@field close fun(fd: timerfd_fd_c): integer]]
	--[[@field read fun(fd: timerfd_fd_c, buf: ffi.cdata*, count: integer): integer]]
	--[[@field timerfd_create fun(clockid: integer, flags: integer): timerfd_fd_c]]
	--[[@field timerfd_settime fun(fd: timerfd_fd_c, flags: integer, new_value: itimerspec, old_value: { [0]: itimerspec }?): integer]]
	--[[@field timerfd_gettime fun(fd: timerfd_fd_c, curr_value: { [0]: itimerspec }): integer]]
	--[[@type timerfd_c]]
	...
	--[[@diagnostic disable-next-line: assign-type-mismatch]]
	--: (cdata, cdata) -> cdata
	local itimerspec = (ffi.typeof --[[: any]])("struct itimerspec") --[[:! (cdata, cdata) -> cdata]]
