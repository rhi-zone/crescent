...
## Web / UI
`lib/web/` framework (middleware, routing, cookies, CSRF, static, html builder, reactive_dom). Router, canvas (PPM/PGM/BMP), color toolchain, TUI on top of ANSI, layout, pretty_print, barcode, qrencode (wip).
