...
- [ ] **bench-col** `[tooling]` Column threading missing in bench_chkt.lua and corpus_extract.lua: provenance is synthetic with col=0 — lib/type/experiments/v5_perf/bench_chkt.lua; lib/type/experiments/v5_perf/corpus_extract.lua
