...
Factorio-style data/control-stage lifecycle, support for multiple mod-loader paradigms as
separate libraries, and the internal gap/quality audit behind it — see
