...
- [ ] **No digit-system substitution.** `lib/locale`'s new `fa`/`fa-IR` momayyez entry (see below) formats digits as Western 0-9; Extended Arabic-Indic digits (U+06F0-U+06F9) are a distinct, unimplemented concern from decimal-separator convention.
