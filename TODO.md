...
- [x] **ccv2 import-time conversion + library integration.** Import pipeline embeds runtime (113bc18). Daemon `POST /api/import-card/upload` accepts raw PNG (113bc18). Library app now has "Import Card" button + drag-drop → calls that endpoint (62d2224).
