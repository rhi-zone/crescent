...
- [x] **`pcall`/`xpcall` de-specialcase** — spec written: `docs/pcall-despecialcase-spec.md`. `$PcallReturn<F>` intrinsic. Delegated.
- [x] **`pairs`/`ipairs` de-specialcase** — spec written: `docs/pairs-despecialcase-spec.md`. `$PairsReturn<T>`/`$IpairsReturn<T>` intrinsics. Delegated.
