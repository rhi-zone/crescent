...
Compute (memb Int_to_Int (VFun [(VInt 1, VInt 2); (VStr 0, VStr 0)])). (* true *)
(* str->bool graph in Str->Bool. *)
Compute (memb Str_to_Bool (VFun [(VStr 0, VBool true)])).             (* true *)
...
Compute (memb Int_to_Int (VFun [(VInt 1, VStr 0)])).                  (* false *)
...
Compute (memb Str_to_Bool (VFun [(VStr 0, VInt 9)])).                 (* false *)
(* a non-function value inhabits NO arrow type. *)
Compute (memb Int_to_Int (VInt 3)).                                  (* false *)
Compute (memb Int_to_Int (VStr 0)).                                  (* false *)
